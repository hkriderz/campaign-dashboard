...
export default function Sidebar({ tags, basePath }: SidebarProps) {
  ...
  return (
    <aside className="w-56 flex-shrink-0 border-r border-gray-200/80 dark:border-white/10 bg-white/80 dark:bg-gray-950/90 backdrop-blur-xl min-h-full py-5 px-2.5">
